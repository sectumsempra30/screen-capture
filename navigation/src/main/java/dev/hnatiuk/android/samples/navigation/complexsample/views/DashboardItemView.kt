package dev.hnatiuk.android.samples.navigation.complexsample.views
...
import dev.hnatiuk.android.samples.navigation.complexsample.model.Box
import dev.hnatiuk.android.samples.navigation.databinding.ViewDashboardItemBinding
...
class DashboardItemView(
    ...
    private val binding: ViewDashboardItemBinding

    init {
        val inflater = LayoutInflater.from(context)
        inflater.inflate(R.layout.view_dashboard_item, this, true)
        binding = ViewDashboardItemBinding.bind(this)
